...
public class GardenHCI extends JFrame {
    ...
    private void initWelcome(float temperature, float luminosity, float ph) {// TODO: Init with real value(temperapure,
                                                                             // humidité, etc...)
    ...
    private void initHelp() { // TODO: mis à jour avec les informations correspondants
        ...
        JLabel jLabelHelp1 = new JLabel(
                "<html><body>1. \"accueil\"<br/>Pour retourner au page d'accueil.</body></html>");
        ...
        JLabel jLabelHelp5 = new JLabel("<html><body>5. \"exit\" [chiffre]<br/>Pour quitter.</body></html>");// TODO:
                                                                                                             // (pour
                                                                                                             // developper),
                                                                                                             // a
                                                                                                             // supprimer
    ...
    public void launchHCI(float temperature, float luminosity, float ph, int waterSensorValueFloor1,
            int waterSensorValueFloor2, int waterSensorValueFloor3) {
        initHCI();
